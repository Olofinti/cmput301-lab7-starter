...
public class MainActivityTest {
    ...
    public void testActivitySwitch() {
        ...
        // Click on the city "Edmonton" in the list
        onData(is(instanceOf(String.class))).inAdapterView(withId(R.id.city_list)).atPosition(0).perform(click());

        // Check if ShowActivity is displayed by checking for textView_cityName
    ...
    public void testBackButton() {
        ...
        // Check if we are back in MainActivity by checking for city_list
